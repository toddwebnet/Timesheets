    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="block full">
                ...
                <!-- END Toggle Menu Title -->

                <!-- Toggle Menu Content -->
                <ul class="toggle-menu">
                    <li>
                        <a href="javascript:void(0)" class="submenu"><i class="fa fa-angle-right"></i> Dashboard</a>
                        <ul>
                    ...
                    <li class="open">
                        <a href="javascript:void(0)" class="submenu"><i class="fa fa-angle-right"></i> UI Elements</a>
                        <ul>
                            <li><a href="javascript:void(0)">Modals</a></li>
                            <li><a href="javascript:void(0)">Tooltips</a></li>
                            <li class="open">
                                <a href="javascript:void(0)" class="submenu"><i class="fa fa-angle-right"></i> Navigation</a>
                                <ul>
                                    <li><a href="javascript:void(0)">Tabs</a></li>
                                    <li><a href="javascript:void(0)">Pagination</a></li>
                                </ul>
                            </li>
                    ...
                    <li>
                        <a href="javascript:void(0)" class="submenu"><i class="fa fa-angle-right"></i> Components</a>
                        <ul>
                    ...
                    <li><a href="javascript:void(0)">Email Center</a></li>
                    <li><a href="javascript:void(0)">Social Net</a></li>
                    <li><a href="javascript:void(0)">Media Box</a></li>
                </ul>
                <!-- END Toggle Menu Content -->
            </div>
            <!-- END Toggle Menu Block -->
            ...
            <div class="block full">
                ...
                <!-- Tabs Content -->
                <div class="tab-content">
                    <div class="tab-pane active" id="block-tabs-home">Block Tabs..</div>
