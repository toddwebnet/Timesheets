    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="block">
                ...
                <form action="page_forms_components.php" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Unchecked</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Checked</label>
                        <div class="col-md-9">
            ...
            <div class="block">
                ...
                <form action="page_forms_components.php" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" id="example-colorpicker" name="example-colorpicker" class="form-control input-colorpicker" value="#5ccdde">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" id="example-colorpicker3" name="example-colorpicker3" class="form-control input-colorpicker-rgba" value="rgba(92, 205, 222, 1)">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="block">
                ...
                <form action="page_forms_components.php" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-timepicker">Time</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-timepicker24">Time (24h)</label>
                        <div class="col-md-5">
                            <div class="input-group bootstrap-timepicker">
